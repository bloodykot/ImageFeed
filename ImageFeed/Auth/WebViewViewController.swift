...
final class WebViewViewController: UIViewController {
    ...
    private func loadWebView() {
        ...
        urlComponents.queryItems = [
            URLQueryItem(name: QueryParam.clientID, value: AccessKey),
            URLQueryItem(name: QueryParam.redirectURI, value: RedirectURI),
            URLQueryItem(name: QueryParam.responseType, value: WebConstants.code),
            URLQueryItem(name: QueryParam.scope, value: AccessScope)
        ]
