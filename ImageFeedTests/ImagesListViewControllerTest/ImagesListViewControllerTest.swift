...
final class ImagesListTest: XCTestCase {
    ...
    func testImagesListViewPresenterFuncs() {
        ...
        XCTAssertEqual(presenter.imageHeight(currentImage: 0), 5221.0)
        XCTAssertEqual(presenter.imageWidth(currentImage: 0), 7831.0)
        XCTAssertFalse(presenter.isLiked(currentImage: 0))
        XCTAssertEqual(presenter.thumbImageURL(currentImage: 0), URL(string: "https://images.unsplash.com/photo-1682687982501-1e58ab814714?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MTA2NjV8MXwxfGFsbHwxfHx8fHx8Mnx8MTcwODg4NTg1MHw&ixlib=rb-4.0.3&q=80&w=200"))
    }
}
